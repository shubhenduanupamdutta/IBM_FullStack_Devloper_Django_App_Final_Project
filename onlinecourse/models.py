...
# Enrollment model
# <HINT> Once a user enrolled a class, an enrollment entry should be created between the user and
# course And we could use the enrollment to track information such as exam submissions
class Enrollment(models.Model):
    ...
    def __str__(self) -> str:
        return f"Enrollment: {self.user} in {self.course} ({self.mode})"
...
class Question(models.Model):
    ...
    def is_get_score(self, selected_ids: list[int]) -> bool:
